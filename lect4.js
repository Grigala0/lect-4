...
const tbilisiBatumi = Object.keys(weatherData);
for (let i = 0; i < tbilisiBatumi.length; i++) {
    const cityKey = tbilisiBatumi[i];
...
console.log("Evening forecast for Tbilisi: " + weatherData.Tbilisi.forecast.evening.conditions);